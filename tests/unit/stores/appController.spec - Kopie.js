...
describe('test "stores/appController"', () => {
  ...
  test('whether progressTypingCheck plays correct key sound audio when enabled', async () => {
    ...
    // ✅ Spy on constructor
    const spyAudioConstructor = vi.spyOn(window, 'Audio');

    // ✅ Spy on play() of the mock class
    ...
    expect(spyAudioConstructor).toHaveBeenNthCalledWith(1, './good.mp3');
    expect(spyAudioConstructor).toHaveBeenNthCalledWith(2, './good.mp3');
    expect(spyAudioConstructor).toHaveBeenNthCalledWith(3, './bad.mp3');
    ...
    expect(spyAudioConstructor).toHaveBeenNthCalledWith(4, './good.mp3');
    expect(spyAudioConstructor).toHaveBeenNthCalledWith(5, './bad.mp3');
    expect(spyAudioConstructor).toHaveBeenNthCalledWith(6, './good.mp3');

    spyPlay.mockRestore();
    spyAudioConstructor.mockRestore();
  });
